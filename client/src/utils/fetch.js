...
export const getProduct = async (productId) => {
    ...
    if (productId) {
        try {
            const response = await fetch(`${API_URL}/products/${productId}`, { method: 'GET' });
...
export const getActiveProduct = async () => {
    ...
    try {
        const response = await fetch(`${API_URL}/active/product/`, { method: 'GET' });
...
export const getProductTestimonials = async (productId) => {
    ...
    if (productId) {
        try {
            const response = await fetch(`${API_URL}/testimonials/?product_id=${productId}`, { method: 'GET' });
...
export const getSiteConfig = async () => {
    ...
    try {
        const response = await fetch(`${API_URL}/active/site_config/`, { method: 'GET' });
